function initChatbot() {
  ...
  const greetings = [
    ...
    "Hi there! I am Valoris - your Trusted AI Navigator. How can I help you today?<br><div class='chat-link-card' onclick='window.location.href=\"/contact.html\"'><div class='card-icon'>✉️</div><div class='card-content'><strong>Contact Us</strong><span>Go to our contact page</span></div><span class='card-arrow'>→</span></div>",
